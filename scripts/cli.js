...
const contractABI = require("../artifacts/contracts/Insightmesh.sol/Insightmesh.json").abi;

program
    .name("insightmesh-cli")
    .description("CLI tool for Insightmesh smart contract")
    .version("1.0.0");
